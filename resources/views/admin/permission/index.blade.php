...
@section('content')
            ...
            <div class="row page-title-row" id="dangqian" style="margin:5px;">
                <div class="col-md-6">
                    @if($fid==0)
                        <span style="margin:3px;" id="fid" attr="{{ $fid }}" class="btn-flat text-info"> 顶级菜单</span>
                       @else
                        <span style="margin:3px;" id="fid"  attr="{{ $fid }}" class="text-info"> {{$data->display_name}}
                        </span>
                    <a style="margin:3px;"  href="javascript:history.back(-1);"
                            class="btn btn-warning btn-md animation-shake reloadBtn"><i class="fa fa-mail-reply-all"></i> 返回上级菜单
                    </a>
                    @endif
                </div>

                <div class="col-md-6 text-right">
                    <a href="/admin/permission/{{$fid}}/create" class="btn btn-success btn-md"><i class="fa fa-plus-circle"></i> 添加权限 </a>
                </div>
            </div>
