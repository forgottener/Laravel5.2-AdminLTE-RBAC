...
<head>
  ...
  {{--loding--}}
  <link href="{{ asset("/bower_components/AdminLTE/dist/css/load/load.css") }}" rel="stylesheet">
  @yield('css')
</head>
...
<script src="{{ asset("/bower_components/AdminLTE/plugins/datatables/dataTables.bootstrap.js") }}"></script>
<script src="{{ asset("/bower_components/AdminLTE/dist/js/common.js") }}"></script>
